...
return [
    ...
    'plugin_more' => '<a href="https://feggu.org/plugin.html" target=_new><i class="fa fa-download" aria-hidden="true"></i> Download more HERE</a>',
    'manager'     => 'Plugins manager',
    'Shipping'    => 'Shipping <span class="right badge badge-warning">' . count(au_get_all_plugin('Shipping')) . '</span>',
    'Shipping_plugin'    => 'Shipping extension',
    'Payment'     => 'Payment <span class="right badge badge-warning">' . count(au_get_all_plugin('Payment')) . '</span>',
    'Payment_plugin'     => 'Payment extension',
    'Total'       => 'Total <span class="right badge badge-warning">' . count(au_get_all_plugin('Total')) . '</span>',
    'Total_plugin'       => 'Total extension',
    'Other'       => 'Other plugin <span class="right badge badge-warning">' . count(au_get_all_plugin('Other')) . '</span>',
    'Other_plugin'       => 'Other plugin',
    'Cms' => 'Cms plugins <span class="right badge badge-warning">' . count(au_get_all_plugin('Cms')) . '</span>',
    'Cms_plugin' => 'Cms plugins',
    'Api' => 'Api plugins <span class="right badge badge-warning">' . count(au_get_all_plugin('Api')) . '</span>',
    'Api_plugin' => 'Api plugins',
    'Block' => 'Block plugins <span class="right badge badge-warning">' . count(au_get_all_plugin('Block')) . '</span>',
