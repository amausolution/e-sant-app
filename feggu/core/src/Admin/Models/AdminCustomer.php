...
class AdminCustomer extends FegguConsultation
{
    ...
    public static function getCustomerListAdmin(array $dataSearch)
    {
        ...
        $customerList = (new FegguConsultation)
            ->where('partner_id', session('adminPartnerId'));
    ...
    {
        return FegguPatientAddress::find($id);
    }
    ...
    {
        return FegguPatientAddress::where('id', $id)->delete();
    }
    ...
    public static function getListAll()
    {
        if (self::$getList === null) {
            self::$getList = self::where('partner_id', session('adminPartnerId'))
                ->get()->keyBy('id');
        }
        return self::$getList;
    }
