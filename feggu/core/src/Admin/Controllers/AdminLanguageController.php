...
class AdminLanguageController extends RootAdminController
{
    ...
    {
        $data = [
            'title' => au_language_render('admin.language.list'),
            'title_action' => '<i class="fa fa-plus" aria-hidden="true"></i> ' . au_language_render('admin.language.add_new_title'),
            'subTitle' => '',
            'icon' => 'fa fa-indent',
            'urlDeleteItem' => au_route_partner('admin_language.delete'),
            'removeList' => 0, // 1 - Enable function delete list item
            'buttonRefresh' => 0, // 1 - Enable button refresh
            'buttonSort' => 0, // 1 - Enable button sort
            'css' => '',
            'js' => '',
            'url_action' => au_route_partner('admin_language.create'),
        ];

        $listTh = [
            'id' => 'ID',
            'name' => au_language_render('admin.language.name'),
            'code' => au_language_render('admin.language.code'),
            'icon' => au_language_render('admin.language.icon'),
            'rtl' => au_language_render('admin.language.layout_rtl'),
            'sort' => au_language_render('admin.language.sort'),
            'status' => au_language_render('admin.language.status'),
        ...
        foreach ($dataTmp as $key => $row) {
            $dataTr[] = [
                ...
                'action' => '
                    <a href="' . au_route_partner('admin_language.edit', ['id' => $row['id']]) . '"><span title="' . au_language_render('action.edit') . '" type="button" class="btn btn-flat btn-sm btn-primary"><i class="fa fa-edit"></i></span></a>&nbsp;
    ...
    public function postCreate()
    {
        ...
        return redirect()->route('admin_language.edit', ['id' => $obj['id']])->with('success', au_language_render('action.create_success'));
    }
    ...
    public function edit($id)
    {
        ...
        'css' => '',
        'js' => '',
        'url_action' => au_route_partner('admin_language.edit', ['id' => $language['id']]),
        'language' => $language,
    ];
