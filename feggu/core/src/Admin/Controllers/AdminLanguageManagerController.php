...
class AdminLanguageManagerController extends RootAdminController
{
    ...
    public function index()
    {
        ...
        if (!in_array($lang, array_keys($codeLanguages))) {
            ...
            $languagesPositionEL = Languages::getLanguagesPosition('fr', $position, $keyword);
        }
        ...
        $urlUpdateData = au_route_partner('admin_language_manager.update');
        $data = [
            'languages' => $languages,
            'lang' => $lang,
            ...
            'title' => au_language_render('admin.language_manager.title'),
            'subTitle' => '',
            'icon' => 'fa fa-indent',
    ...
    public function add()
    {
        ...
        $positionLang = Languages::getPosition();
        $data = [
            'title' => au_language_render('admin.language_manager.add'),
            'positionLang' => $positionLang,
            'languages' => $languages,
        ];
    ...
    public function postAdd()
    {
        ...
        return redirect(au_route_partner('admin_language_manager.index'))->with('success', au_language_render('action.create_success'));
    }
}
