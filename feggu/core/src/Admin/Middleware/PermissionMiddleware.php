...
use Feggu\Core\Admin\Permission;
...
class PermissionMiddleware
{
    ...
    protected function shouldPassThrough($request)
    {
        ...
        $exceptsPAth = [
            AU_ADMIN_PREFIX . '/auth/login',
            AU_ADMIN_PREFIX . '/auth/logout',
        ];
    ...
    */
    ...
    {
        return [
            AU_ADMIN_PREFIX . '/uploads/delete',
            AU_ADMIN_PREFIX . '/uploads/newfolder',
            AU_ADMIN_PREFIX . '/uploads/domove',
            AU_ADMIN_PREFIX . '/uploads/rename',
            AU_ADMIN_PREFIX . '/uploads/resize',
            AU_ADMIN_PREFIX . '/uploads/doresize',
            AU_ADMIN_PREFIX . '/uploads/cropimage',
            AU_ADMIN_PREFIX . '/uploads/crop',
            AU_ADMIN_PREFIX . '/uploads/move',
        ];
    }
}
