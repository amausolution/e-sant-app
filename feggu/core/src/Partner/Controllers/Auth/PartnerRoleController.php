...
class PartnerRoleController extends RootPartnerController
{
    ...
    {
        $data = [
            'title' => au_language_render('admin.role.list'),
            'subTitle' => '',
            'icon' => 'fa fa-indent',
            'urlDeleteItem' => au_route_partner('admin_role.delete'),
        ...
        foreach ($dataTmp as $key => $row) {
            ...
            $dataTr[] = [
                ...
                'action' => ((in_array($row['id'], AU_GUARD_ROLES)) ? '' : '
                    <a href="' . au_route_partner('admin_role.edit', ['id' => $row['id']]) . '"><span title="' . au_language_render('action.edit') . '" type="button" class="btn btn-flat btn-sm btn-primary"><i class="fa fa-edit"></i></span></a>&nbsp;
                    ')
        ...
        //menuRight
        $data['menuRight'][] = '<a href="' . au_route_partner('admin_role.create') . '" class="btn  btn-success  btn-flat" title="New" id="button_create_new">
        ...
        $data['urlSort'] = au_route_partner('admin_role.index', request()->except(['_token', '_pjax', 'sort_order']));
    ...
    public function create()
    {
        $data = [
            ...
            'url_action' => au_route_partner('admin_role.create'),
    ...
    public function postCreate()
    {
        ...
        return redirect()->route('admin_role.index')->with('success', au_language_render('action.create_success'));
    }
    ...
    public function edit($id)
    {
        ...
        $data = [
            ...
            'permission' => (new AdminPermission)->pluck('name', 'id')->all(),
            'userList' => (new AdminUser)->pluck('name', 'id')->all(),
            'url_action' => au_route_partner('admin_role.edit', ['id' => $role['id']]),
        ];
        return view($this->templatePathAdmin.'auth.role')
            ->with($data);
    }
...
//
        return redirect()->route('admin_role.index')->with('success', au_language_render('action.edit_success'));
    }
