<?php
#Feggu/Core/Partner/Models/FegguLanguage.php
namespace Feggu\Core\Partner\Models;

use Illuminate\Database\Eloquent\Model;

class FegguLanguage extends Model
{
    public $table = AU_DB_PREFIX.'feggu_language';
    ...
    protected static function boot()
    {
        ...
        static::deleting(function ($model) {
            if (in_array($model->id, AU_GUARD_LANGUAGE)) {
                return false;
            }
        });
    }
