<?php
/**
 * @author Amadou wade <amainformatic@gmail.com>
 */
...
class FegguCurrency extends Model
{
    public $table = AU_DB_PREFIX.'feggu_currency';
    ...
    protected static function boot()
    {
        ...
        static::deleting(function ($model) {
            if (in_array($model->id, AU_GUARD_CURRENCY)) {
                return false;
            }
        });
    }
