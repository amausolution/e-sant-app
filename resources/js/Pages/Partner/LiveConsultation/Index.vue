                        ...
                        <div class="navbar">
                            <div class="user-details">
                                <div class="float-left user-img">
                                    <a class="avatar" href="profile.html" :title="$page.props.auth.user.name">
                                        <img :src="$page.props.avatar" alt="" class="rounded-circle">
                                        <span class="status online"></span>
                                    </a>
                                </div>
                                <div class="user-info float-left">
                                    <a href="profile.html"><span>{{$page.props.auth.user.name}}</span></a>
                    ...
                    <div class="chat-contents">
                        <div class="chat-content-wrap">
                            <div class="user-video">
                                <img src="/partner/assets/img/video-call.jpg" alt="">
                            </div>
                            <div class="my-video">
                                <ul>
                                    <li>
                                        <img src="/partner/assets/img/profiles/avatar-01.jpg" class="img-fluid" alt="">
                                    </li>
                                </ul>
                            </div>
                        </div>
                                        ...
                                        <div class="chat chat-left">
                                            <div class="chat-avatar">
                                                <a href="profile.html" class="avatar">
                                                    <img alt="" src="/partner/assets/img/profiles/avatar-02.jpg">
                                                </a>
                                            </div>
                                            <div class="chat-body">
