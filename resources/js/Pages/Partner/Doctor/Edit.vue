                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="grid grid-flow-row-dense grid-cols-3 grid-rows-3 gap-2">
                                <div class="flex items-center" v-for="roleUser in roles" :key="roleUser.id">
                                    <div class="custom-control">
                                        <input :name="`rols[${roleUser.id}]`" :value="roleUser.id" type="checkbox"
                                               v-model="form.role" class="custom-control-input"
                                               :id="`role-${roleUser.id}`"

                                        >
                                        <label class="custom-control-label" :for="`role-${roleUser.id}`">{{ roleUser.name}} </label>
                                    </div>
                                    <label :for="`role-${roleUser.id}`" class="col-form-label"></label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="grid grid-flow-row-dense grid-cols-3 grid-rows-3 gap-2">
                                ...
                                <div class="flex items-center" v-for="permission in permissions" :key="permission.id">
                                    <div class="custom-control ">
                                        <input :name="`permission[${permission.id}]`" :value="permission.id" type="checkbox" v-model="form.permissionUser"
        ...
        setup(props){
            const form = useForm({
                  // _method: 'put',
                   ...
                   department: props.user.departments,
                   specialities: props.user.specialisations,
                   role: props.user.roles,
                   permissionUser: props.user.permissions,
        ...
        methods:{
            ...
            submit() {
              /*  if (this.$refs.photo) {
                 ...
                 this.form.put(route('doctor.update',this.user.id),{
                 })
            },
