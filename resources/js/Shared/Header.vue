<template>
    ...
    <div class="header">
        ...
        <ul class="nav user-menu">
            ...
            <li class="nav-item dropdown has-arrow main-drop">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" :href="route('partner.setting')">{{__('Settings')}}</a>
                    <a class="dropdown-item" :href="route('partner.logout') ">{{__('Logout')}}</a>
                </div>
            </li>
        </ul>
        <!-- /Header Menu -->
        ...
        <div class="dropdown mobile-user-menu">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <Link class="dropdown-item" :href="route('partner.profile')">{{__('My Profile')}}</Link>
                <Link class="dropdown-item" :href="route('partner.setting')">{{__('Settings')}}</Link>
                <Link class="dropdown-item" :href="route('partner.logout') ">{{__('Logout')}}</Link>
            </div>
        </div>
        <!-- /Mobile Menu -->
