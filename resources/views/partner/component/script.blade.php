...
<script type="text/javascript">
    ...
    (function($) {
        $(".integer-validation").keypress((function (e) {
    ...
    (function( $ ){
        ...
        $.fn.filemanager = function(type, options) {
            ...
            this.on('click', function(e) {
                ...
                var route_prefix = (options && options.prefix) ? options.prefix : '{{ au_route_partner('partner.home').'/'.config('lfm.url_prefix') }}';
                var target_input = $('#' + $(this).data('input'));
                var target_preview = $('#' + $(this).data('preview'));
                window.open(route_prefix + '?type=' + type, '{{ au_language_render('admin.file_manager') }}', 'width=900,height=600');
