@php
    $totalOrder = \Feggu\Core\Admin\Models\AdminOrder::count();
    $styleStatus = \Feggu\Core\Admin\Models\AdminOrder::$mapStyleStatus;
@endphp
@if ($totalOrder)
@php
    $arrStatus = \Feggu\Core\Front\Models\ShopOrderStatus::pluck('name','id')->all();
    $groupOrder = (new \Feggu\Core\Front\Models\ShopOrder)->all()->groupBy('status');
@endphp
    <li id="summary">
    <ul>
